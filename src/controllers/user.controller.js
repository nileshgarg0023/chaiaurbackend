...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(401, error, "Invalid refreshToken");
  }
});
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, channel[0], "user channel fetced succesfully"));
});
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        user[0].watchHistory,
        "Watcher History Fetched successfully"
      )
    );
});
